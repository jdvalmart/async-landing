...
const API = 'https://youtube-v31.p.rapidapi.com/search?channelId=UChDBtoAIbiQOHasctzRedsg&part=snippet%2Cid&order=date&maxResults=1';
...
const options = {
	...
	headers: {
		'X-RapidAPI-Host': 'youtube-v31.p.rapidapi.com',
        'X-RapidAPI-Key': '16b70969a6msh004574ace8eb401p1c691cjsna2de214cc118'
	}
};
